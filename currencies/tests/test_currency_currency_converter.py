...
class TestCurrencyPricePortifolioConverter(PacsTestCase):
    ...
    def test_conversion_to_final_currency_always_works(self):
        ...
        assert converter.convert(five_reais, self.real, date(2019, 1, 1)) == (five_reais)
        assert converter.convert(five_reais, self.real, date(1993, 11, 23)) == (five_reais)
    ...
    def test_conversion_between_currencies(self):
        ...
        converter = self.get_converter()
        assert converter.convert(five_euros, self.real, date(2019, 1, 1)) == (Money(20, self.real))
        assert converter.convert(five_euros, self.real, date(2019, 2, 1)) == (Money(40, self.real))
