...
from movements.serializers import (
    MovementSpecSerializer,
    TransactionSerializer,
    TransactionTagSerializer,
)
from movements.tests.factories import TransactionTagFactory, TransactionTestFactory
...
class TestMovementSpecSerializer(MovementsSerializersTestCase):
    def setUp(self):
        ...
        self.data = {"account": self.acc.pk, "money": MoneySerializer(self.money).data}
...
class TransactionSerializerTest(MovementsSerializersTestCase):
    def setUp(self):
        super().setUp()
        self.accs = AccountTestFactory.create_batch(3, acc_type=AccTypeEnum.LEAF)
        ...
        self.tags = [TransactionTagFactory.build()]
        self.data = {
            "description": "hola",
            ...
            "tags": [TransactionTagSerializer(self.tags[0]).data],
        }
    ...
    def test_serialize_base(self):
        ...
        assert ser.data == {
            ...
            "tags": [TransactionTagSerializer(m).data for m in trans.get_tags()],
        }
    ...
    def test_update_movements_specs(self):
        ...
        assert [mov.money.quantity for mov in movements] == [Decimal(100), Decimal(-100)]
