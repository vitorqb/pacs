...
test_data = {
    "periods": [["2001-01-12", "2003-01-31"], ["2003-02-02", "2003-02-28"]],
    "accounts": [1, 2, 3],
}
...
class TestPeriodField(PacsTestCase):
    ...
    def test_base_to_representation(self):
        ...
        res = PeriodField().to_representation(Period(date(2018, 1, 1), date(2018, 2, 1)))
        assert exp == res
...
class TestFlowEvolutionInputSerializer:
    ...
    def test_base(self):
        ...
        assert resp["periods"] == [PeriodField().to_internal_value(x) for x in data["periods"]]
                    ...
                    "flows": [
                        {
                            ...
                            "moneys": [{"currency": 1, "quantity": "2.00000"}],
                        }
                    ],
                }
            ]
...
class TestCurrencyPricePortifolioSerializer:
    @staticmethod
    def get_data():
        return {"currency": "EUR", "prices": [{"date": "2019-01-01", "price": 12}]}
    ...
    def test_base(self):
        ...
        assert validated_data == {
            ...
            "prices": [{"date": date(2019, 1, 1), "price": Decimal(12)}],
        }
